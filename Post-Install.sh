...
# Native Applications
#####################
yay -Syu --noconfirm btrfs-assistant btrfsmaintenance fwupd zerotier-one nextcloud-client syncthing qpdf inkscape appimagelauncher-bin uxplay weylus-bin solaar game-devices-udev oversteer fastfetch koi
